...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DBASTAROW_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DBASTAROW actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DBASTAROW actions', async () => {
      const arg = { id: 30689 };
    ...
    it('dispatches UPDATE_DBASTAROW actions', async () => {
      const arg = { id: 30689 };
    ...
    it('dispatches PARTIAL_UPDATE_DBASTAROW actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DBASTAROW actions', async () => {
      const arg = 42666;
