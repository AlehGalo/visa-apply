...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DDOMAKINROW_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DDOMAKINROW actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DDOMAKINROW actions', async () => {
      const arg = { id: 18221 };
    ...
    it('dispatches UPDATE_DDOMAKINROW actions', async () => {
      const arg = { id: 18221 };
    ...
    it('dispatches PARTIAL_UPDATE_DDOMAKINROW actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DDOMAKINROW actions', async () => {
      const arg = 42666;
