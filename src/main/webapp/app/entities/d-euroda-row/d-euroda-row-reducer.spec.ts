...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEURODAROW_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DEURODAROW actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DEURODAROW actions', async () => {
      const arg = { id: 5732 };
    ...
    it('dispatches UPDATE_DEURODAROW actions', async () => {
      const arg = { id: 5732 };
    ...
    it('dispatches PARTIAL_UPDATE_DEURODAROW actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DEURODAROW actions', async () => {
      const arg = 42666;
