...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DFINGERSROW_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DFINGERSROW actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DFINGERSROW actions', async () => {
      const arg = { id: 5780 };
    ...
    it('dispatches UPDATE_DFINGERSROW actions', async () => {
      const arg = { id: 5780 };
    ...
    it('dispatches PARTIAL_UPDATE_DFINGERSROW actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DFINGERSROW actions', async () => {
      const arg = 42666;
