...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DIMAGESROW_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DIMAGESROW actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DIMAGESROW actions', async () => {
      const arg = { id: 26634 };
    ...
    it('dispatches UPDATE_DIMAGESROW actions', async () => {
      const arg = { id: 26634 };
    ...
    it('dispatches PARTIAL_UPDATE_DIMAGESROW actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DIMAGESROW actions', async () => {
      const arg = 42666;
