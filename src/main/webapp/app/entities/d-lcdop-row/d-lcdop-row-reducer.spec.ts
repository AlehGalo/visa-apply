...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DLCDOPROW_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DLCDOPROW actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DLCDOPROW actions', async () => {
      const arg = { id: 24274 };
    ...
    it('dispatches UPDATE_DLCDOPROW actions', async () => {
      const arg = { id: 24274 };
    ...
    it('dispatches PARTIAL_UPDATE_DLCDOPROW actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DLCDOPROW actions', async () => {
      const arg = 42666;
