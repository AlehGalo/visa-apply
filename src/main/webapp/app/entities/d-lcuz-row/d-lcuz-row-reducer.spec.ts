...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DLCUZROW_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DLCUZROW actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DLCUZROW actions', async () => {
      const arg = { id: 11093 };
    ...
    it('dispatches UPDATE_DLCUZROW actions', async () => {
      const arg = { id: 11093 };
    ...
    it('dispatches PARTIAL_UPDATE_DLCUZROW actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DLCUZROW actions', async () => {
      const arg = 42666;
