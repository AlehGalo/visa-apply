...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DLOADOSFENTITY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DLOADOSFENTITY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DLOADOSFENTITY actions', async () => {
      const arg = { id: 22622 };
    ...
    it('dispatches UPDATE_DLOADOSFENTITY actions', async () => {
      const arg = { id: 22622 };
    ...
    it('dispatches PARTIAL_UPDATE_DLOADOSFENTITY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DLOADOSFENTITY actions', async () => {
      const arg = 42666;
