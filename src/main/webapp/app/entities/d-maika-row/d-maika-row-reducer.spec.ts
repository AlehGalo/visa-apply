...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DMAIKAROW_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DMAIKAROW actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DMAIKAROW actions', async () => {
      const arg = { id: 21986 };
    ...
    it('dispatches UPDATE_DMAIKAROW actions', async () => {
      const arg = { id: 21986 };
    ...
    it('dispatches PARTIAL_UPDATE_DMAIKAROW actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DMAIKAROW actions', async () => {
      const arg = 42666;
