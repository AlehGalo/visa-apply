...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DMSGHEADERROW_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DMSGHEADERROW actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DMSGHEADERROW actions', async () => {
      const arg = { id: 20037 };
    ...
    it('dispatches UPDATE_DMSGHEADERROW actions', async () => {
      const arg = { id: 20037 };
    ...
    it('dispatches PARTIAL_UPDATE_DMSGHEADERROW actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DMSGHEADERROW actions', async () => {
      const arg = 42666;
