...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DSAPRUGAROW_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DSAPRUGAROW actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DSAPRUGAROW actions', async () => {
      const arg = { id: 25777 };
    ...
    it('dispatches UPDATE_DSAPRUGAROW actions', async () => {
      const arg = { id: 25777 };
    ...
    it('dispatches PARTIAL_UPDATE_DSAPRUGAROW actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DSAPRUGAROW actions', async () => {
      const arg = 42666;
