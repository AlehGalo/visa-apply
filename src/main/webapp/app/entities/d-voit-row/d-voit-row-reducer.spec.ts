...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DVOITROW_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DVOITROW actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DVOITROW actions', async () => {
      const arg = { id: 2670 };
    ...
    it('dispatches UPDATE_DVOITROW actions', async () => {
      const arg = { id: 2670 };
    ...
    it('dispatches PARTIAL_UPDATE_DVOITROW actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DVOITROW actions', async () => {
      const arg = 42666;
