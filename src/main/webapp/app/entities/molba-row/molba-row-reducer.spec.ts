...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './molba-row.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MOLBAROW_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MOLBAROW actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MOLBAROW actions', async () => {
      const arg = { id: 3853 };
    ...
    it('dispatches UPDATE_MOLBAROW actions', async () => {
      const arg = { id: 3853 };
    ...
    it('dispatches PARTIAL_UPDATE_MOLBAROW actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MOLBAROW actions', async () => {
      const arg = 42666;
